...
startBtn.onclick = async () => {
  try {
    ...
    // Combine audio tracks (system + mic) with screen video tracks
    const combinedStream = new MediaStream();

    // Add screen video tracks
    localStream.getVideoTracks().forEach(track => combinedStream.addTrack(track));

    // Add audio tracks from screen and mic (if available)
    ...
    // Replace localStream with combinedStream for sending to viewers
