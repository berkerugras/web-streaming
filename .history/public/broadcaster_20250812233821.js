...
socket.on('offer', async ({ from, sdp }) => {
  // This is the key change. We should handle offers from viewers
  // regardless of whether they have a main PC already.
  // We'll use a separate PC for the viewer's audio stream.
  if (!viewerPcs[from]) {
